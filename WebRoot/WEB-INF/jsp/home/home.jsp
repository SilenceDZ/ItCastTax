        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，${SYS_USER.name }&nbsp;</font></a>
                    </td>
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.SYS_USER.headImg != null && #session.SYS_USER.headImg != ''}">
                            	<img src="${ctx}/upload/${SYS_USER.headImg}" width="70" height="70" />
                            </s:if><s:else>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">${SYS_USER.name }</td>
                        </tr>
                        <tr>
                            <td colspan="2">所属部门：${SYS_USER.dept }</td>
                        </tr>
                    </table>
                    </td>
                </tr>
